...
with open('C:\\Users\\saaji\\AudioToText\\src\\portals\\admins\\outfile', 'rb') as fp:
...
def make_prediction_on_file(file):
    ...
    import IPython.display as ipd
    import matplotlib.pyplot as plt
    list_of_words = settings.load_model_(file)
    if list_of_words:
    ...
    # here outfile is the label file of all the dataset use labels.pkl only
    with open('C:\\Users\\saaji\\AudioToText\\labels.pkl', 'rb') as fp:
        all_label = pickle.load(fp)
    ...
    for i, chunk in enumerate(chunks):
        ...
        try:
            # load model
            model = load_model('C:\\Users\\saaji\\AudioToText\\new_model.h5')
            # reashape the file
            ...
            print(classes[index])
            list_of_words.append(classes[index])
        except:
            print()
    return concatenate(list_of_words)
